...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, ElectricRelay_GridConnector_Pin|ElectricRelay_LoadConnector_Pin|ElectricRelay_BridgeA_Pin|ElectricRelay_BridgeB_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, ISync_Pin|IAds_nReset_Pin|IAds_nCs_Pin|VSync_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, VAds_nCs_Pin|VAds_nReset_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = ElectricRelay_GridConnector_Pin|ElectricRelay_LoadConnector_Pin|ElectricRelay_BridgeA_Pin|ElectricRelay_BridgeB_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : PBPin PBPin */
  GPIO_InitStruct.Pin = IAds_nReset_Pin|IAds_nCs_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = VAds_nCs_Pin|VAds_nReset_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
