...
#define ElectricRelay_AllLoad_Pin GPIO_PIN_0
#define ElectricRelay_AllLoad_GPIO_Port GPIOA
#define ElectricRelay_LoadConnector_Pin GPIO_PIN_1
#define ElectricRelay_LoadConnector_GPIO_Port GPIOA
#define ElectricRelay_BridgeB_Pin GPIO_PIN_2
...
#define ElectricRelay_GridConnector_Pin GPIO_PIN_7
